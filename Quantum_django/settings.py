"""
Django settings for Quantum_django project.
...
SECRET_KEY = '#e)$zd-arvy*y%6iys81bdx=78cw)gy5i9s#@=7$piq4qtzu8t'
...
ROOT_URLCONF = 'Quantum_django.urls'
